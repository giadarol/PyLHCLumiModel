...
def Lumi_inst(Number_bunches, bunch_intensity_p1, bunch_intensity_p2, ex_norm_m1, ey_norm_m1, ex_norm_m2, ey_norm_m2, bl_4sigma_s1, bl_4sigma_s2, betastar_m, phi_full_rad, gamma, experiment):
    ...
    return FF*fr*Number_bunches*bunch_intensity_p1*bunch_intensity_p2/(sigmax_m*sigmay_m)/4./pi


def LumiModel(gamma=None, betastar_m=None, phi_full_rad=None, experiment=None, bunch_intensityin_p1=None, bunch_intensityin_p2=None, exin_norm_m1=None,	exin_norm_m2=None, eyin_norm_m1=None, eyin_norm_m2=None, blin_4sigma_s1=None, blin_4sigma_s2=None, tFill_s=None,tauSRxy_s=None, tauSRl_s=None, sigmaBOff_m2=None, VRF_V=None, IBSON=1, emitBU="Model", BoffON=1, nIPs = 2., dt_s=15*60., tau_empirical_h1=None, tau_empirical_v1=None, tau_empirical_h2=None, tau_empirical_v2=None):
    ...
    Lumi_init = Lumi_inst(Number_bunches=1., bunch_intensity_p1=bunch_intensityin_p1, bunch_intensity_p2=bunch_intensityin_p2, 
			...
			bl_4sigma_s1=blin_4sigma_s1, bl_4sigma_s2=blin_4sigma_s2, 
                        betastar_m=betastar_m, phi_full_rad=phi_full_rad, gamma=gamma, experiment=experiment)
    
    
    Luminosity_invm2s = [(Lumi_init*0.8 + Lumi_init*0.8)/2.]
    ...
    for i_step in xrange(1, N_steps):
        ...
        if emitBU=='Model':	
            ex_norm_m1.append(ex_IBS_norm_m1)
            ey_norm_m1.append(ey_norm_m1[i_step-1]*exp(-2*dt_s/tauSRxy_s));                                                                                                                                                                                
            ex_norm_m2.append(ex_IBS_norm_m2)
            ey_norm_m2.append(ey_norm_m2[i_step-1]*exp(-2*dt_s/tauSRxy_s));     
	    bl_4sigma_s1.append(bl_IBS_4sigma_s1)
	    bl_4sigma_s2.append(bl_IBS_4sigma_s2)  
        elif emitBU=='EmpiricalBlowup':
            ex_norm_m1.append(ex_norm_m1[i_step-1]*exp(dt_s/tau_empirical_h1))
            ey_norm_m1.append(ey_norm_m1[i_step-1]*exp(dt_s/tau_empirical_v1))
            ex_norm_m2.append(ex_norm_m2[i_step-1]*exp(dt_s/tau_empirical_h2))
            ey_norm_m2.append(ey_norm_m2[i_step-1]*exp(dt_s/tau_empirical_v2))
	    bl_4sigma_s1.append(bl_4sigma_s1[i_step-1]*exp(-dt_s/tauSRl_s/2.5))
	    bl_4sigma_s2.append(bl_4sigma_s2[i_step-1]*exp(-dt_s/tauSRl_s/2.5))
#            ex_norm_m1.append(ex_norm_m1[i_step-1]+dt_s/tau_empirical_h1)
#            ey_norm_m1.append(ey_norm_m1[i_step-1]+dt_s/tau_empirical_v1);
#            ex_norm_m2.append(ex_norm_m2[i_step-1]+dt_s/tau_empirical_h2)
#            ey_norm_m2.append(ey_norm_m2[i_step-1]+dt_s/tau_empirical_v2);
        ...
        Luminosity_invm2s.append(0.8*Lumi_inst(Number_bunches=1., bunch_intensity_p1=bunch_intensity_p1[i_step], bunch_intensity_p2=bunch_intensity_p2[i_step], ex_norm_m1=ex_norm_m1[i_step], ey_norm_m1=ey_norm_m1[i_step], ex_norm_m2=ex_norm_m2[i_step], ey_norm_m2=ey_norm_m2[i_step], bl_4sigma_s1=bl_4sigma_s1[i_step], bl_4sigma_s2=bl_4sigma_s2[i_step], betastar_m=betastar_m, phi_full_rad=phi_full_rad, gamma=gamma, experiment=experiment))


    return tt_s, Luminosity_invm2s, bunch_intensity_p1, bunch_intensity_p2, ex_norm_m1, ex_norm_m2, ey_norm_m1, ey_norm_m2, bl_4sigma_s1, bl_4sigma_s2
