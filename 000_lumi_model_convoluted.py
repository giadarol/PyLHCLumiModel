import numpy as np
import pylab as pl
from LumiModel_convoluted_values import LumiModel
...
tt_s, Luminosity_invm2s, bunch_intensity_p1, bunch_intensity_p2, ex_norm_m1, ex_norm_m2, ey_norm_m1, ey_norm_m2, bl_4sigma_s1, bl_4sigma_s2 = LumiModel(gamma=gamma, betastar_m=betastar_m, phi_full_rad=full_Xing_angle, experiment='CMS', bunch_intensityin_p1=bunch_intensity, bunch_intensityin_p2=bunch_intensity, exin_norm_m1=n_emittx_init_m, eyin_norm_m1=n_emitty_init_m,  exin_norm_m2=n_emittx_init_m, eyin_norm_m2=n_emitty_init_m, blin_4sigma_s1=bunch_length_init_ns, blin_4sigma_s2=bunch_length_init_ns, tFill_s=tFill_s, tauSRxy_s=tauSRxy_s, tauSRl_s=tauSRl_s, sigmaBOff_m2=sigmaBOff_m2, VRF_V=VRF_V, IBSON=1, emitBU=emitBU, BoffON=1, nIPs = 2., dt_s=15*60., tau_empirical_h=tau_empirical_h, tau_empirical_v=tau_empirical_v)
...
pl.plot(tt_s/3600., na(bl_4sigma_s1), linewidth=2.)
pl.plot(tt_s/3600., na(bl_4sigma_s2), linewidth=2.)
...
pl.plot(tt_s/3600., na(ex_norm_m1), label='H', linewidth=2.)
pl.plot(tt_s/3600., na(ey_norm_m1), label='V', linewidth=2.)
pl.plot(tt_s/3600., na(ex_norm_m2), label='H', linewidth=2.)
pl.plot(tt_s/3600., na(ey_norm_m2), label='V', linewidth=2.)
