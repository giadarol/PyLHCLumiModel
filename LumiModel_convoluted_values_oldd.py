...
def LumiModel(gamma=None, betastar_m=None, phi_full_rad_ATLAS=None, phi_full_rad_CMS=None, experiment=None, bunch_intensityin_p1=None, bunch_intensityin_p2=None, exin_norm_m1=None,	exin_norm_m2=None, eyin_norm_m1=None, eyin_norm_m2=None, blin_4sigma_s1=None, blin_4sigma_s2=None, tFill_s=None,tauSRxy_s=None, tauSRl_s=None, sigmaBOff_m2=None, VRF_V=None, IBSON=1, emitBU="Model", BoffON=1, nIPs = 2., dt_s=15*60., tau_empirical_h1=None, tau_empirical_v1=None, tau_empirical_h2=None, tau_empirical_v2=None):
    ...
    Lumi_init_AT = Lumi_inst(Number_bunches=1., bunch_intensity_p1=bunch_intensityin_p1, bunch_intensity_p2=bunch_intensityin_p2, 
    ...
    Luminosity_AT_invm2s = [Lumi_init_AT]
    Luminosity_CMS_invm2s = [Lumi_init_CMS]    
    Luminosity_invm2s = [(Lumi_init_AT + Lumi_init_CMS)/2.]
	...
	Lumi_CMS = Lumi_inst(Number_bunches=1., bunch_intensity_p1=bunch_intensity_p1[i_step], bunch_intensity_p2=bunch_intensity_p2[i_step], ex_norm_m1=ex_norm_m1[i_step], ey_norm_m1=ey_norm_m1[i_step], ex_norm_m2=ex_norm_m2[i_step], ey_norm_m2=ey_norm_m2[i_step], bl_4sigma_s1=bl_4sigma_s1[i_step], bl_4sigma_s2=bl_4sigma_s2[i_step], betastar_m=betastar_m, phi_full_rad=phi_full_rad_CMS, gamma=gamma, experiment='CMS')  
        ...
        Luminosity_invm2s.append((Lumi_AT+Lumi_CMS)/2.)
	Luminosity_AT_invm2s.append(Lumi_AT)
	Luminosity_CMS_invm2s.append(Lumi_CMS)

    if experiment == 'ATLAS':
	return tt_s, Luminosity_AT_invm2s, bunch_intensity_p1, bunch_intensity_p2, ex_norm_m1, ex_norm_m2, ey_norm_m1, ey_norm_m2, bl_4sigma_s1, bl_4sigma_s2
    if experiment == 'CMS':
	return tt_s, Luminosity_CMS_invm2s, bunch_intensity_p1, bunch_intensity_p2, ex_norm_m1, ex_norm_m2, ey_norm_m1, ey_norm_m2, bl_4sigma_s1, bl_4sigma_s2,  
